  ...
  return (
    <>
      ...
      <LeftInfo
        ...
        paragraph="Le Réseau d'Étudiants Visionnaires et Engagés est une association située à Grenoble dont l'objectif est de promouvoir l'éducation, le développement personnel et culturel des étudiants ainsi que leur intégration dans la vie professionnelle."
